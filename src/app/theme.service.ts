...
function CSSTextGenerator(colors) {
  ...
  return `
    ...
    --ion-color-primary-tint: ${Color(primary).darken(shadeRatio)};

    --ion-color-secondary: ${secondary};
    --ion-color-secondary-rgb: 12, 209, 232;
    --ion-color-secondary-contrast: ${contrast(primary)};
    --ion-color-secondary-contrast-rgb: 255, 255, 255;
    --ion-color-secondary-shade: ${Color(secondary).darken(shadeRatio)};
    --ion-color-secondary-tint: ${Color(secondary).darken(shadeRatio)};
    ...
    --ion-color-tertiary-tint: ${Color(tertiary).darken(shadeRatio)};
    ...
    --ion-color-success-tint: ${Color(success).darken(shadeRatio)};
    ...
    --ion-color-warning-tint: ${Color(warning).darken(shadeRatio)};
    ...
    --ion-color-danger-tint: ${Color(danger).darken(shadeRatio)};
    ...
    --ion-color-dark-tint: ${Color(dark).darken(shadeRatio)};
    ...
    --ion-color-medium-tint: ${Color(medium).darken(shadeRatio)};
    ...
    --ion-color-light-tint: ${Color(light).darken(shadeRatio)};
`;
}
